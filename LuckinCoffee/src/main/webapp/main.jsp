...
<title>瑞幸咖啡管理系统主页</title>


<script type="text/javascript">
function deleteCoffee(id) {
	if(confirm("你确定要删除记录吗？")==true)
		window.location="CoffeeServlet?action=delete&id="+id;
}
</script>
</head>
<body>
...
<a type="button" class="btn btn-warning" href="addCoffee.jsp">添加咖啡</a>
</form><br>


<div class="panel panel-default">
  <div class="panel-heading"><p><font size="Impact">Luckin Coffee</font></p>
  ...
  <table class="table">
	...
	<td><a href="editCoffee.jsp?action=update&id=${coffee.id}">修改</a></td>
	
	<td><a href="main.jsp;" onclick="deleteCoffee(${coffee.id})">删除</a></td>
	</tr>
	</c:forEach>
